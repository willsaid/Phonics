package com.hearatale.phonic.data.prefs;
...
import com.hearatale.phonic.data.network.api.base.json.JsonArray;
import com.hearatale.phonic.data.network.api.base.json.JsonObject;
...
public class AppPreferencesHelper implements PreferencesHelper {
    ...
    public List<PieceModel> getPiecesCompletedByLetter(String letter) {
        ...
        if (mPref.contains(Constants.Preferences.SIMPLE_LETTERS + letter)) {
            ...
            if (!com.hearatale.phonic.utils.Helper.isListValid(listPiecesCompleted)) {
