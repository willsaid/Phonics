package com.hearatale.phonic.utils.glide;
...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.hearatale.phonic.utils.glide.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.hearatale.phonic.utils.glide.GlideOptions().apply(toSet));
    }
  }
}
